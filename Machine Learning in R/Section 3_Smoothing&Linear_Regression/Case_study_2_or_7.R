...
# explore data by plottign the two predictors
...
# So much more code, but I don't think I have learned that far yet, hence moving on to comprehension check instead
